...
<head>
    ...
    <title>Oxireal | Iniciar Sesión</title>
    ...
    <link rel="shortcut icon" href="{{ asset('images/logos/'.$fav->image) }}" type="image/png">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="logo-login">
                    ...
                    <img class="responsive-img" src="{{ asset('images/logos/'.$logoh->image) }}">
